...
module.exports = ({ usuario, recovery}, cb)=>{
    ...
    <br/>
    <p>
            Aqui está o link para recuperação de senha. Acesse-o e digite sua nova senha:
       </p>
       ...
       ${link}/v1/api/usuarios/senha-recuperada?token=${recovery.token}
        ...
        <br /> <br /> <hr />
        <p>
            Obs.: Se você não solicitou a redefinição. apenas ignore esse e-mail.
        <p />
        <br />
       ...
       if( process.env.NODE_ENV === "production"){
        transporter.sendMail(opcoesEmail, (error, info)=>{
            if(error){
                ...
                return cb(null, "Link para redefinição de senha foi enviado com sucesso para seu e-mail")
            }
        })
       }else{
